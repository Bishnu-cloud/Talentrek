"""
Django settings for talentrek project.
...
# Media files (for resumes upload)
MEDIA_URL = '/media/'
...
# This loads it and returns True if it actually found the file
file_found = load_dotenv(dotenv_path=env_path)
...
# Add these for better flow
ACCOUNT_EMAIL_REQUIRED = False
ACCOUNT_EMAIL_VERIFICATION = 'none'

# Email settings for development (just prints emails in terminal)
